...
dataSet[dataSetVersion].options = [
  ...
  },
  {
	...
	sub: [
	  ...
	  { name: "Toto Academy", tooltip: " ", key: "toto" },
	  ...
	  { name: "Ojimachi Academy", tooltip: " ", key: "ojimachi" },
	  ...
	  { name: "Setagaya Agriculture and Forestry Academy", tooltip: " ", key: "setagaya" },
  ...
  },
  {
	...
	sub: [
	  ...
	  { name: "MMA Fight Club (Front)", tooltip: " ", key: "mmafront" },
...
******/
  ...
  {
	name: "Cinderella",
	img: "3-star/icon_cinderella01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "no_guild" ],
	  school: [ "fire" ],
  ...
  {
	name: "Yurugu",
	img: "3-star/icon_yurugu01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "exters", "no_guild" ],
	  school: [ "ojimachi" ],
	  world: [ "agisymba" ],
	  gender: [ "male" ],
	}
  ...
  {
	name: "Azathoth αΩ",
	img: "3-star/icon_azathothalphaomega01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "exters" ],
	  school: [ "satellite" ],
	  world: [ "tokyo", "old_ones" ],
	  gender: [ "male" ],
	}
  },
  {
	name: "Enigma ∀",
	img: "3-star/icon_enigmaaureole01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "exters" ],
	  school: [ "satellite" ],
  ...
  {
	name: "Cheshire Cat",
	img: "3-star/icon_cheshirecat01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "exters" ],
	  school: [ "satellite" ],
  ...
  {
	name: "Demiurge",
	img: "3-star/icon_demiurge01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "independent" ],
	  school: [ "satellite" ],
  ...
  },
  {
	...
	opts: {
	  ...
	  school: [ "kudan", "kiou" ],
	  other: [ "mmafront", "mmaback" ],
	  world: [ "shangri-la", "devaloka" ],
	  gender: [ "male" ],
	}
  },
  {
	name: "Glashtyn",
	img: "3-star/icon_glashtyn01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "independent" ],
	  school: [ "setagaya" ],
  ...
  {
	name: "Aegipan",
	img: "3-star/icon_aegipan01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "independent" ],
	  school: [ "roppongi" ],
	  world: [ "olympus", "old_ones" ],
	  gender: [ "male" ],
	}
  },
  {
  ...
  {
	name: "Cu Chulainn",
	img: "3-star/icon_cuchulainn01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "agents" ],
	  school: [ "nakano" ],
  ...
  {
	name: "Mynoghra",
	img: "3-star/icon_mynoghra01.png",
	opts: {
	  rarity: [ "3+" ],
	  guild: [ "wanderers" ],
	  school: [ "no_school" ],
...
******/
  ...
  },
  {
	...
	opts: {
	  ...
	  guild: [ "no_guild" ],
	  school: [ "no_school" ],
	  world: [ "oceanic_realm", "great_spirit" ],
	  gender: [ "male" ],
	  unreleased: true
	}
  },
